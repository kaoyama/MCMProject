...
/**
 * Put all targeted deals for the specific user in the "customerDeals" table. 
 * This script should be called after the update location script. Queries 
 * tables "customers", "userTransactions", "merchantProductType", "deals", and 
 * "customerDeals."
 */
...
$getMerchants = "SELECT merchant FROM kd268.userTransactions WHERE customer='" .
        $_SESSION['user'] . "'";
...
while ($merchant = mysql_fetch_assoc($merchants)) {
    ...
    $getProductTypes = "SELECT type FROM kd268.merchantProductType WHERE " .
            " merchant='$merchant'";
