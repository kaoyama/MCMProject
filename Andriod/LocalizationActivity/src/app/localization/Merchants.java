...
/**
 * Merchant list. Pulls subscribed or nearby merchant information from the
...
public class Merchants extends Activity {
	...
	/**
	 * Initializes the page when it is first called.
	 */
	...
	/**
	 * Retrieve a list of subscribed merchants from the database.
	 */
				...
				public void run() {
					...
					try {
						...
						for (int i = 0; i < jsonArray.length(); i++) {
							listContents.add(jsonArray.getJSONObject(i)
									.getString("merchantUserName"));
						}

						// Save this information to be used in the Merchant Map
						// page
